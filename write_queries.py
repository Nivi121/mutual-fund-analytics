...
print("=" * 55)
print("  TASK 6: 10 ANALYTICAL SQL QUERIES")
print("=" * 55)
...
queries_path.write_text(all_queries_text, encoding="utf-8")
print(f"\n\n  💾 All queries saved to sql/queries.sql")
...
print("=" * 55)
print("\n  Next → run  py create_data_dictionary.py")